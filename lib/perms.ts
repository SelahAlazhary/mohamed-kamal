...
const APPEARANCE_KEYS = new Set([
  ...
  "toolbarStyle", "navbarStyle", "navbarStick", "toolbarStick", "navbarHidden", "toolbarHidden", "appIcon", "appIconImage", "buttonStyle", "glow", "heroShell", "heroShellOpts", "googleMeet", "azhariBackdrop", "artTint", "artDepth", "designColors", "studentPanel", "shadowStyle", "ambient", "ambientSpeed", "hero3d", "brandSignature", "signatureImage", "signatureHeight", "signatureInvert", "iconLib", "iconFrame", "iconFrameColors", "iconCover", "iconMotion", "developer", "maintenance", "mobileHome", "motionStyle",
